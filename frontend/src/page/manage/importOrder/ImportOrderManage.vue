    ...
    <div class="import-order-manage">
        <div class="page-heading">
            <div>
                ...
                <p class="page-desc">管理采购入库和采购退货单据</p>
            </div>
            <router-link class="btn-primary" to="/manage/import-order/add">+ 新建采购单</router-link>
        </div>
        ...
        <div class="order-table-card">
            <div class="table-toolbar">
                ...
                <input v-model="searchQuery" class="order-search" placeholder="搜索单号或供应商" type="text"/>
            </div>
            ...
            <div class="modal-content confirm-modal">
                <div class="modal-body">
                    <div class="confirm-box">
                        ...
                        <div class="confirm-msg">确定要删除采购单“{{ deleteTarget?.importOrderNo }}”吗？</div>
