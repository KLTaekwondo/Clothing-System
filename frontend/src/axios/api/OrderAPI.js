...
const orderAPI = {
    ...
    searchCurrentCompleteOrderPage: (page, size, startTime, endTime, employeeId) => backendService.get("/order/search/wareHouse/complete", {params: {page, size, startTime, endTime, employeeId}}),
}
